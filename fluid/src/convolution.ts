import {fft32 as fft, ifft32 as ifft, FlatFFT32 as FlatFFT, numbers} from "flat-fft";
...
export const convolve2d = function(arr1: numbers, arr2: numbers, width: number, height: number){
    return FlatFFT.toReal(convolve2dComplex(FlatFFT.toComplex(arr1),FlatFFT.toComplex(arr2), width, height));
};
